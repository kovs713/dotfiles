...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_GRV,   KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,                                   KC_N,        KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,         BSLS_LANG,
    ...
    [1] = LAYOUT(
        ...
        S(KC_GRV), S(KC_MINS),  S(KC_EQL),   KC_MINS,     KC_EQL,      KC_NO,                                  KC_CAPS,       S(KC_LBRC),  S(KC_RBRC),  S(KC_COMM),   S(KC_DOT),      KC_NO,
